    ...
    return(
        ...
        <div className= "form-cadastro">
            <form className="text-center form-login mx-auto mt-5">
                ...
                <div className="msg-login text-black my-5 text-center">
                    {msgTipo === 'sucesso' && <spam><strong>WoW!</strong> Usuário cadastrado com Sucesso &#128526;</spam>}
                    {msgTipo === 'erro' && <spam><strong>Ops!</strong> {msg} &#128546; </spam>}
                </div>
             </form>
    </div> 
    </>)
